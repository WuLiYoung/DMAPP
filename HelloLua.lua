...
print(os.date("%x"));
print(os.date("%X"));
fulltime = os.date("%Y-%m-%d%%20%H:%M:%S");
print("current full time is :"..fulltime);
print(os.date("%c"));

panelSN = "bBCDEF1234567890G";
local ProductType = "C100";
if string.char(string.byte(panelSN,1)) ~= "A" and string.char(string.byte(panelSN,1)) ~= "a" then
    ProductType = "C101";
end
print("type is "..ProductType);
trynum = math.huge;
print(trynum);
trysum = trynum + 90;
print(trysum);
